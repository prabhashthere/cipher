...
public class EncryptHome extends javax.swing.JFrame {
    ...
    String line;
    String fullText = "";
    static String fullTextReplaced;
    static String fullTextShuffled;

    public static String getFullTextReplaced() {
        return fullTextReplaced;
    }
    ...
    private void attachbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attachbtnActionPerformed
        ...
        fullTextReplaced = EncryptorDecryptor.replaceLetters(fullText);
        fullTextShuffled = EncryptorDecryptor.shuffle(keyVal,fullTextReplaced);
        System.out.println(fullTextShuffled);
        ...
        try {
            ...
            writer.write(fullTextShuffled);
            writer.close();
        } catch (IOException ex) {
            Logger.getLogger(EncryptHome.class.getName()).log(Level.SEVERE, null, ex);
        }

        deId.setPathEncryptedTxt(encryptedFile.getAbsolutePath());
        deId.show();
